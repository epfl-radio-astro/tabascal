          ...
          for (INT_T i_int_f = 0; i_int_f < n_int_f; ++i_int_f) {
            ...
            for (INT_T i_int_t = lane_id; i_int_t < n_int_t;
              ...
              const auto val_rfi_amp_grad_1 =
                  rfi_amp_fine_grad(i_a1, i_f, i_t, i_rfi, i_int_ft);
              const auto val_rfi_amp_grad_2 =
                  rfi_amp_fine_grad(i_a2, i_f, i_t, i_rfi, i_int_ft);
              ...
              const auto val_rfi_phase_grad_1 =
                  rfi_phase_grad(i_a1, i_f, i_t, i_rfi, i_int_ft);
              const auto val_rfi_phase_grad_2 =
                  rfi_phase_grad(i_a2, i_f, i_t, i_rfi, i_int_ft);
...
ffi::Error calc_rfi_jvp_gpu_dispatch(
  ...
  Tensor5D<const cuDoubleComplex *, INT_T> rfi_amp_fine_grad_tensor(
  ...
  Tensor5D<const double *, INT_T> rfi_phase_grad_tensor(
