...
Nothing but `GPInterpVis` reads a data-grid phase, so these pair with that component and a data-grid signal component; the fine-grid kernels refuse the shape.
