...
## Signal-domain - {class}`~tabascal.components.rfi_signal.RealRFI`, {class}`~tabascal.components.rfi_signal.ComplexRFI`


## Fourier-domian - {class}`~tabascal.components.rfi_signal.FourierGPRFI`