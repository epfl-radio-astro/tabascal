...
def test_wants_rfi_axis_matching():
    ...
    assert not dist._wants_rfi_axis("_c/RealRFIVarAnt/L_rfi_A", np.zeros((3, 3)), n_rfi)
...
_MULTI_DEVICE_SCRIPT = textwrap.dedent(
    ...
    tree = {
        ...
        "_c/RealRFIVarAnt/L_rfi_A": rng.normal(size=(4, 4)),   # name-excluded
    ...
    assert sharded["_c/RealRFIVarAnt/L_rfi_A"].sharding.spec == P()
