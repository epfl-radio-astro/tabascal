"""Offline acceptance and caching tests for nearest-only TLE resolution.

The batching, validation, and endpoint-selection layer these policies sit on is
tested in the satchecker-client package; what stays here is what tabascal
decides: source precedence, age ceilings, coverage enforcement, and the
boundary failover between the two archives.
"""
...
tle = orbit
from satchecker_client import client, SatCheckerTransportError
from satchecker_client import service
